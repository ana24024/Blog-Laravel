    ...
    <div class= "container" style="width: 800px;">
        <div class= "container" style="width: 800px;">
            ...
            <div class="container-fluid" style="width: 500px">
                ...
                <form action="{{route('publicacion.agregar')}}" method="POST">
                    @csrf
                    @error('titulo')
                        <br>
                ...
                <div class="card" style="background: rgb(226, 241, 247)">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="form-inline">
                            <form action="{{route('publicacion.eliminar', $publicacion->idPublicacion)}}" method="POST">
                                @csrf
                                <a href="{{route('publicacion.editar',$publicacion->idPublicacion)}}" class="btn btn-primary">Editar</a>
